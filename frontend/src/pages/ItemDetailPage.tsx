...
import { Heart, Star, MessageCircle, ArrowLeft, User } from 'lucide-react';
...
const ItemDetailPage: React.FC = () => {
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-eco-cream flex items-center justify-center">
        <div className="text-eco-green-primary">Loading...</div>
      </div>
    );
  }
    ...
    return (
      <div className="min-h-screen bg-eco-cream flex items-center justify-center">
        <div className="text-center">
          <h2 className="text-2xl font-bold text-eco-brown mb-4">Item not found</h2>
          <Link to="/browse" className="text-eco-green-primary hover:underline">
            Back to browse
          </Link>
        </div>
      </div>
  ...
  const getConditionColor = (condition: string) => {
    switch (condition) {
      case 'like-new': return 'text-eco-green-primary bg-eco-green-primary/10';
      case 'good': return 'text-eco-green-secondary bg-eco-green-secondary/10';
      case 'fair': return 'text-eco-tan bg-eco-tan/10';
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-4">
            <div className="aspect-square bg-white rounded-lg overflow-hidden shadow-md">
              <img
                src={item.images[0] || 'https://i.pinimg.com/1200x/50/77/8a/50778a92f2a5490280e135b63432fc08.jpg'}
                alt={item.title}
          ...
          <div className="space-y-6">
            <div>
              <div className="flex items-start justify-between mb-4">
                <h1 className="text-3xl font-bold text-eco-brown">{item.title}</h1>
              ...
              <div className="flex items-center space-x-2 mb-6">
                ...
                <span className="font-medium text-eco-brown">{item.owner.username}</span>
